...
import shutil
import random
rand = random.sample(range(0, 256), 100)
...
output_dir = '/home/wzhou14fall/output4' 
        ...
        if scene['scene_id'] in scenes:
            ...
            for model in models:
                ...
                for frame in model['selected_frames']:
                    ...
                    feature2 = features[2].squeeze(0)[rand]
                    #print(feature2.size())
                    torch.save(feature2, str(scene_output_dir)+'/'+ features_fn)
